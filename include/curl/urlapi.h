 ...
 *
 * Flags: the CURLU_* bitmask defines described above.
 *
 * for all
 *
 * - CURLU_URLDECODE returns the string URL decoded. If there's a %00
 *   in there then, curl_url_get() returns CURLUE_URLDECODE.
 *
 * for URL
 *
 * - CURLU_DEFAULT_SCHEME makes this function use "https" for scheme
 *   instead of failure if no scheme was set.
 * - CURLU_DEFAULT_PORT makes this function insert the port number in the
 *   URL even if it matches the default for the used scheme.
 *
 * for SCHEME
 *
 * - CURLU_DEFAULT_SCHEME makes this function return "https" instead of
 *   failure if no scheme was set.
 * - CURLU_NON_SUPPORT_SCHEME allows this function to return a scheme name
 ...
 *
 * - CURLU_DEFAULT_PORT makes this function return the default port number
 ...
 * a relative URL is passed in, CURLUE_RELATIVE is returned.
 *
 * for SCHEME
 *
 * - CURLU_NON_SUPPORT_SCHEME allows this function to accept scheme names
